...
export function Github(svgProps: SVGProps<SVGSVGElement>) {
  return (
    <svg fill="currentColor" viewBox="0 0 496 512" {...svgProps}>
...
export function LinkedIn(svgProps: SVGProps<SVGSVGElement>) {
  return (
    <svg fill="currentColor" viewBox="0 0 448 512" {...svgProps}>
...
export function Mail(svgProps: SVGProps<SVGSVGElement>) {
  return (
    <svg fill="currentColor" viewBox="0 0 512 512" {...svgProps}>
